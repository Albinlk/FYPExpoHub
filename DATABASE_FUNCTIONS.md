...
| `submit_report_version` | record owner | F6: report + original plagiarism report (both in the record's folder) and similarity index, required and ≤ 30 % (`20260926000005`); page / reference counts with the textbook minimums (proposal 30 pages / 15 refs, final 50 / 30, at least half academic) and, for a proposal involving human subjects, the REC ethics form (`20260927000002`) |
...
| `request_milestone_extension` | record owner | Extension request: reason required, new date after the current target and not in the past (MYT), one pending per milestone, not for completed milestones; audited (`20260926000012`) |
