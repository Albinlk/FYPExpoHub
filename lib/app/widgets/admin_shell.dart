          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                _buildSidebarItem(context, 'Pengurusan Pensyarah', Icons.school, '/admin/lecturers'),
                _buildSidebarItem(context, 'Pengumuman', Icons.campaign, '/admin/announcements'),
                _buildSidebarItem(context, 'Lawatan Pelajar', Icons.visibility, '/admin/visits'),
                _buildSidebarItem(context, 'Lawatan Saya (Lecturer)', Icons.person_pin, '/lecturer/visits'),
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  _buildDrawerItem(context, 'Pengurusan Pensyarah', Icons.school, '/admin/lecturers'),
                  _buildDrawerItem(context, 'Pengumuman', Icons.campaign, '/admin/announcements'),
                  _buildDrawerItem(context, 'Lawatan Pelajar', Icons.visibility, '/admin/visits'),
                  _buildDrawerItem(context, 'Lawatan Saya (Lecturer)', Icons.person_pin, '/lecturer/visits'),
