...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,eventId,slug,title,matricId,programmeCode,programmeName,shortDescription,category,const DeepCollectionEquality().hash(technologyTags),boothId,boothNumber,boothZone,coverImageUrl,posterUrl,const DeepCollectionEquality().hash(teamDisplayNames),supervisorDisplayName,examinerDisplayName,demoUrl,videoUrl,repositoryUrl,featured,calonIndustri,publicationStatus,createdAt,updatedAt,publishedAt]);

@override
String toString() {
  return 'Project(id: $id, eventId: $eventId, slug: $slug, title: $title, matricId: $matricId, programmeCode: $programmeCode, programmeName: $programmeName, shortDescription: $shortDescription, category: $category, technologyTags: $technologyTags, boothId: $boothId, boothNumber: $boothNumber, boothZone: $boothZone, coverImageUrl: $coverImageUrl, posterUrl: $posterUrl, teamDisplayNames: $teamDisplayNames, supervisorDisplayName: $supervisorDisplayName, examinerDisplayName: $examinerDisplayName, demoUrl: $demoUrl, videoUrl: $videoUrl, repositoryUrl: $repositoryUrl, featured: $featured, calonIndustri: $calonIndustri, publicationStatus: $publicationStatus, createdAt: $createdAt, updatedAt: $updatedAt, publishedAt: $publishedAt)';
}
...
@useResult
$Res call({
 String id, String eventId, String slug, String title, String? matricId, String programmeCode, String programmeName, String shortDescription, String category, List<String> technologyTags, String? boothId, String? boothNumber, String? boothZone, String coverImageUrl, String? posterUrl, List<String> teamDisplayNames, String supervisorDisplayName, String? examinerDisplayName, String? demoUrl, String? videoUrl, String? repositoryUrl, bool featured, bool calonIndustri, String publicationStatus, DateTime createdAt, DateTime updatedAt, DateTime? publishedAt
});
...
class _Project implements Project {
  const _Project({required this.id, required this.eventId, required this.slug, required this.title, this.matricId, required this.programmeCode, required this.programmeName, required this.shortDescription, required this.category, required final  List<String> technologyTags, this.boothId, this.boothNumber, this.boothZone, required this.coverImageUrl, this.posterUrl, required final  List<String> teamDisplayNames, required this.supervisorDisplayName, this.examinerDisplayName, this.demoUrl, this.videoUrl, this.repositoryUrl, required this.featured, this.calonIndustri = false, required this.publicationStatus, required this.createdAt, required this.updatedAt, this.publishedAt}): _technologyTags = technologyTags,_teamDisplayNames = teamDisplayNames;
